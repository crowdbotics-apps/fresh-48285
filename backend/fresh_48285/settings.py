"""
Django settings for fresh_48285 project.
...
WSGI_APPLICATION = 'fresh_48285.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fresh_48285 API",
    "DESCRIPTION": "API documentation for fresh_48285 App",
    "VERSION": "v1",
}
